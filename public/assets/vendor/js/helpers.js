        ...
        var d = {
            ...
            _scrollToActive: function() {
                ...
                if (n) {
                    ...
                    if (i) {
                        ...
                        if (!0 === e) {
                            var u = function() {
                                var e, n, i, l = +new Date - a, c = (e = l,
                                n = r,
                                i = s,
                                (e /= t / 2) < 1 ? i / 2 * e * e + n : -i / 2 * ((e -= 1) * (e - 2) - 1) + n);
                                o.scrollTop = c,
                                l < t ? requestAnimationFrame(u) : o.scrollTop = s
                            };
                            u()
                        } else
                            o.scrollTop = s
            ...
            _bindMenuMouseEvents: function() {
                ...
                if (!(this._menuMouseEnter && this._menuMouseLeave && this._windowTouchStart)) {
                    ...
                    this._menuMouseEnter || (this._menuMouseEnter = function() {
                        return e.isSmallScreen() || e._hasClass("layout-transitioning"),
            ...
            setCollapsed: function() {
                ...
                this._bindLayoutAnimationEndEvent((function() {
                    e.isSmallScreen && e._setCollapsed(t)
                }
                ), (function() {
