!function(e, t) {
  ...
  return function() {
      ...
      function ne(e) {
          var t, n = e.popper, i = e.popperRect, c = e.placement, l = e.variation, u = e.offsets, d = e.position, h = e.gpuAcceleration, p = e.adaptive, v = e.roundOffsets, m = e.isFixed, g = u.x, _ = void 0 === g ? 0 : g, y = u.y, b = void 0 === y ? 0 : y, k = "function" == typeof v ? v({
              x: _,
              y: b
          }) : {
              x: _,
          ...
          if (p) {
              var C = X(n)
                , x = "clientHeight"
                , L = "clientWidth";
              if (C === S(n) && "static" !== q(C = K(n)).position && "absolute" === d && (x = "scrollHeight",
              L = "scrollWidth"),
              c === r || (c === s || c === a) && l === f)
                  O = o,
      ...
      var Te = {
          ...
          fn: function(e) {
              ...
              if (C) {
                  if (l) {
                      var F, H = "y" === O ? r : s, W = "y" === O ? o : a, R = "y" === O ? "height" : "width", z = C[O], q = z + k[H], V = z - k[W], K = _ ? -S[R] / 2 : 0, Q = E === u ? x[R] : S[R], U = E === u ? -S[R] : -x[R], G = t.elements.arrow, J = _ && G ? B(G) : {
                          width: 0,
                          height: 0
                          ...
                          bottom: 0,
                          left: 0
                      }, te = Z[H], ne = Z[W], ie = $(0, x[R], J[R]), re = A ? x[R] / 2 - K - ie - te - j.mainAxis : Q - ie - te - j.mainAxis, oe = A ? -x[R] / 2 + K + ie + ne + j.mainAxis : U + ie + ne + j.mainAxis, ae = t.elements.arrow && X(t.elements.arrow), se = ae ? "y" === O ? ae.clientTop || 0 : ae.clientLeft || 0 : 0, ce = null != (F = null == P ? void 0 : P[O]) ? F : 0, le = z + oe - ce, ue = $(_ ? M(q, z + re - ce - se) : q, z, _ ? N(V, le) : V);
                      C[O] = ue,
                      D[O] = ue - z
                  }
                  if (d) {
                      var fe, de = "x" === O ? r : s, he = "x" === O ? o : a, pe = C[T], ve = "y" === T ? "height" : "width", me = pe + k[de], ge = pe - k[he], _e = -1 !== [r, s].indexOf(w), be = null != (fe = null == P ? void 0 : P[T]) ? fe : 0, ke = _e ? me : pe - x[ve] - S[ve] - be + j.altAxis, we = _e ? pe + x[ve] + S[ve] - be - j.altAxis : ge, Ee = _ && _e ? function(e, t, n) {
                          var i = $(e, t, n);
                          return i > n ? n : i
      ...
      function Fe(e, t, n) {
          return t = Re(t),
          He(e, We() ? Reflect.construct(t, n || [], Re(e).constructor) : t.apply(e, n))
      }
      function He(e, t) {
      ...
      var nt = new Map
        ...
        , lt = function(e) {
          return !(!e || "object" !== tt(e)) && (void 0 !== e.jquery && (e = e[0]),
          void 0 !== e.nodeType)
      }
        , ut = function(e) {
        ...
        , ft = function(e) {
          if (!lt(e) || 0 === e.getClientRects().length)
              return !1;
      ...
      var an = ".bs.swipe"
          ...
          Xe(t, [{
              ...
              value: function() {
                  ...
                  if (!(e <= 40)) {
                      ...
                      this._deltaX = 0,
                      t && bt(t > 0 ? this._config.rightCallback : this._config.leftCallback)
                  }
              }
          }, {
              key: "_initEvents",
        ...
        , Fn = function(e) {
          ...
          Xe(t, [{
              ...
              key: "pause",
              value: function() {
                  this._isSliding && ct(this._element),
                  this._clearInterval()
              }
          }, {
              key: "cycle",
      ...
      var Jn = "dropdown"
        ...
        , wi = function(e) {
          ...
          Xe(t, [{
              ...
              key: "_getConfig",
              value: function(e) {
                  if ("object" === tt((e = Ne(t, "_getConfig", this, 3)([e])).reference) && !lt(e.reference) && "function" != typeof e.reference.getBoundingClientRect)
                      throw new TypeError("".concat(Jn.toUpperCase(), ': Option "reference" provided type "object" without a required "getBoundingClientRect" method.'));
                  return e
              }
          }, {
              key: "_createPopper",
              ...
              value: function() {
                  ...
                  return (this._inNavbar || "static" === this._config.display) && (zt(this._menu, "popper", "static"),
                  e.modifiers = [{
                      name: "applyStyles",
                      enabled: !1
                  }]),
      ...
      Ht.on(document, si, fi, (function(e) {
          e.preventDefault(),
          wi.getOrCreateInstance(this).toggle()
      }
      )),
      yt(wi);
      var Ei = "backdrop"
        ...
        , xi = function(e) {
          ...
          Xe(t, [{
              ...
              value: function(e) {
                  var t = this;
                  this._config.isVisible ? (this._getElement().classList.remove(Ai),
                  this._emulateAnimation((function() {
                      t.dispose(),
                      bt(e)
                  }
              ...
              key: "dispose",
              value: function() {
                  this._isAppended && (Ht.off(this._element, Oi),
                  this._element.remove(),
                  this._isAppended = !1)
              }
          }, {
              ...
              key: "_configAfterMerge",
              value: function(e) {
                  return e.rootElement = ut(e.rootElement),
                  e
              }
          }, {
              key: "_append",
        ...
        , ir = function(e) {
          ...
          Xe(t, [{
              ...
              value: function() {
                  var e = this;
                  this._isShown && !this._isTransitioning && (Ht.trigger(this._element, zi).defaultPrevented || (this._isShown = !1,
                  this._isTransitioning = !0,
              ...
              value: function() {
                  ...
                  if (!Ht.trigger(this._element, qi).defaultPrevented) {
                      ...
                      "hidden" === n || this._element.classList.contains(er) || (t || (this._element.style.overflowY = "hidden"),
      ...
      Ht.on(document, Gi, '[data-bs-toggle="modal"]', (function(e) {
          ...
          ir.getOrCreateInstance(n).toggle(this)
      }
      )),
      $t(ir),
      yt(ir);
              ...
              value: function(e) {
                  return this._config.sanitize ? function(e, t, n) {
                      ...
                      if (n && "function" == typeof n)
                          return n(e);
                      var r, o = (new window.DOMParser).parseFromString(e, "text/html"), a = Ge((i = []).concat.apply(i, Je(o.body.querySelectorAll("*"))));
                      try {
                          for (a.s(); !(r = a.n()).done; ) {
                              var s, c = r.value, l = c.nodeName.toLowerCase();
                              if (Object.keys(t).includes(l)) {
                                  var u, f = (s = []).concat.apply(s, Je(c.attributes)), d = [].concat(t["*"] || [], t[l] || []), h = Ge(f);
                                  try {
                                      for (h.s(); !(u = h.n()).done; ) {
                                          var p = u.value;
              ...
              value: function() {
                  ...
                  if (this._isWithContent() && this._isEnabled) {
                      ...
                      if (!t.defaultPrevented && n) {
                          ...
                          Ht.trigger(this._element, this.constructor.eventName("inserted"))),
                      ...
                      for (n.s(); !(e = n.n()).done; ) {
                          ...
                          if ("click" === i)
                              ...
                              Ht.on(this._element, r, this._config.selector, (function(e) {
                                  ...
                                  n._activeTrigger["focusin" === e.type ? Mr : Nr] = !0,
                                  n._enter()
                              }
                              )),
                  ...
                  try {
                      for (t.s(); !(e = t.n()).done; ) {
                          ...
                          if (n.hash && !dt(n)) {
                              ...
                              ft(i) && (this._targetLinks.set(decodeURI(n.hash), n),
