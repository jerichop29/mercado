...
class SubCategoriesFunction {
    ...
    public function addCategory($data) {
        $sql = "INSERT INTO `categoriestbl-sub` (Category_Id,Title, Description) VALUES (?, ?, ?)";
        $stmt = $this->conn->prepare($sql);
        $stmt->bind_param("iss", $data['Category_Id'], $data['Title'], $data['Description']);
...
$categoriesFunctions = new SubCategoriesFunction();
$action = $_GET['action'] ?? '';
