      ...
      <div className="sidenav-header">
        ...
        >
          <img
            ...
            alt="main_logo"
          />
          <span className="ms-1 font-weight-bold">Mercado De Calamba</span>
        </a>
      </div>
      <hr className="horizontal dark mt-0" />
      <div className="navbar-collapse w-auto h-auto" id="">
        <ul className="navbar-nav">
          ...
          <li className="nav-item">
            <a className="nav-link" href="../pages/tables.html">
              ...
              <span className="nav-link-text ms-1">Sub-users</span>
            </a>
          </li>
          {/* Manage Users */}
          <li className="nav-item">
          ...
          <li className="nav-item">
            <a className="nav-link" href="../pages/tables.html">
              ...
              <span className="nav-link-text ms-1">Manage Property</span>
            </a>
          </li>
          {/* Appointment header */}
          <li className="nav-item mt-3">
            ...
            <a className="nav-link" href="../pages/tables.html">
              ...
              <span className="nav-link-text ms-1">Manage Appointment</span>
            </a>
          </li>
          {/* Complaint Feature header */}
          <li className="nav-item mt-3">
            <h6 className="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">
              Complaint Feature
            </h6>
          ...
          <li className="nav-item">
            <a className="nav-link" href="../pages/profile.html">
              ...
              <span className="nav-link-text ms-1">Manage Complaint</span>
            </a>
          </li>
          {/* Manage Category */}
          <li className="nav-item">
            <a className="nav-link" href="../pages/sign-in.html">
              ...
              <span className="nav-link-text ms-1">Manage Category</span>
            </a>
          </li>
          {/* Reports */}
          <li className="nav-item">
          ...
          <li className="nav-item">
            <a className="nav-link" href="../pages/profile.html">
              ...
              <span className="nav-link-text ms-1">Manage Discover</span>
            </a>
          </li>
        </ul>
      </div>
