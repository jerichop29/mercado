                            ...
                            <div className="card">
                                <div className="card-body">
                                    ...
                                    <small className="text-danger fw-medium"> 
                                        <i className="bx bx-up-arrow-alt"></i> new complaints
                                    </small>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="col-md-4">
                                <div className="card-body">
                                    <div className="text-center">
                                        <div className="dropdown">
                                            <button aria-label='Years selection 2025'
                                ...
                                <div className="d-flex px-xxl-4 px-lg-2 p-4 gap-xxl-3 gap-lg-1 gap-3 justify-content-center">
                        ...
                        <div className="col-6 mb-4">
                            <div className="card">
                                <div className="card-body">
                                    ...
                                    <small className="text-success fw-medium">
                                        <i className="bx bx-up-arrow-alt"></i> new request
                                    </small>
                                </div>
                            </div>
                        </div>
                        <div className="col-6 mb-4">
                            <div className="card">
                                <div className="card-body">
                                    ...
                                    <small className="text-success fw-medium">
                                        <i className="bx bx-up-arrow-alt"></i> Announcements
                                    </small>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div className="d-flex flex-sm-column flex-row align-items-start justify-content-between">
                                            ...
                                            <div className="mt-sm-auto">
                                                <small className="text-success text-nowrap fw-medium">
                                                    <i className="bx bx-chevron-down"></i> Resolved Complaints
                                                </small>
